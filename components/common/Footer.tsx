        ...
        <div className="grid grid-cols-1 md:col-span-3 lg:grid-cols-5 gap-y-7 md:gap-x-7">
          ...
          >
            <div className="flex items-center gap-2">
              <img src="/images/Logo-Green.png" alt="" className="h-[55px]" />
            </div>

            <p className="text-sm leading-relaxed text-zinc-500 mt-4">
              FACE World Leadership School, formerly known as FACE Campus, is a
              residential school in Kerala, India, dedicated to nurturing the
              next generation of global leaders, civil servants, and
